...
//
//        //when
//        ResponseDto<Page<PortfolioResponseDto>> result = portfolioInquiryService.searchPortfolios("success", 1, 9);
//
//        //then
//        assertThat(result)
...
//
//        assertThat(portfolioResults.get(0)).isEqualTo(3L);
//        assertThat(portfolioResults.get(1)).isEqualTo(1L);
//    }
